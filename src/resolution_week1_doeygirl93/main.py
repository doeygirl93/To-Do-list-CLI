...
def main():
    ...
    parser.add_argument("-1", "--list", help="List all tasks", action="store_true")
    ...
    parser.add_argument("-v", "--version", action="store_true", help="See version of this software")
    ...
    if args.list:
        ...
        print(f"This app is version 0.0.1")
